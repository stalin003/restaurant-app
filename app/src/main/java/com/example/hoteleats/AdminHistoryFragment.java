...
public class AdminHistoryFragment extends Fragment {
    ...
    HistoryCustomAdapter customAdapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.admin_history_recycle);
        historyList = new ArrayList<>();
        myDB = new MyDatabaseHelper(view.getContext());

        storeDataInArray(view);

        customAdapter = new HistoryCustomAdapter(view.getContext(), historyList);
        recyclerView.setAdapter(customAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(view.getContext()));
    }

    void storeDataInArray(View view) {
        ...
        if (cursor.getCount() == 0) {
            ...
            while (cursor.moveToNext()) {
                historyList.add(new History(cursor.getString(1), cursor.getString(4), cursor.getString(2), cursor.getString(3)));
            }
        }
    }
}